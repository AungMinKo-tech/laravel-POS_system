                    ...
                    <div id="tab-1" class="tab-pane fade show p-0 active">
                        <div class="row g-4">
                            <div class="col-3">
                                    ...
                                    <div class="col-12">
                                        <form action="{{route('user#Home')}}" method="get">
                                            ...
                                            <select name="sortingType" class="form-control w-100 bg-white mt-3">
                                                ...
                                                <option value="price,asc" @if(request('sortingType') == "price,asc") selected @endif>Price: Low to High</option>
                                                <option value="price,desc" @if(request('sortingType') == "price,desc") selected @endif>Price: High to Low</option>
                                ...
                                <a href="{{route('user#Home')}}"><input type="button" value="Clear Filter" class="btn btn-danger my-3 w-100"></a>
                                            ...
                                            <div class="col-4">
                                                <div class="rounded position-relative fruite-item">
                                                    <div class="fruite-img">
                                                        <a href="{{route('user#productDetails',$item->product_id)}}"><img src="{{ asset('productImage/' . $item->image) }}" style="height: 250px" class="img-fluid w-100 rounded-top" alt=""></a>
                                                    </div>
