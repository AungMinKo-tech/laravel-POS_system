                ...
                <div class="col-lg-8 col-xl-9">
                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-lg-6">
                            ...
                            <span class="text-danger h5">(Only {{ $product->stock }} items left ! )</span>
                            <p class="mb-3 mt-3">Category: {{ $product->category_name }}</p>
                            ...
                            <div class="tab-content mb-5">
                                ...
                                <div class="tab-pane" id="nav-mission" role="tabpanel"
                                    ...
                                    @foreach ($comments as $item)
                                        <div class="d-flex">
                                            <img src="{{ asset($item->profile == null ? 'default/userpp.png' : 'profile/' . $item->profile) }}"
                                            ...
                                            <div class="">
                                                ...
                                                <div class="d-flex justify-content-between">
                                                    ...
                                                    @if ($item->user_id == Auth::user()->id)
                                                        <button type="button"
                                                            class="btn btn-sm rounded btn-outline-danger shadow-sm mx-4"
                                                            onclick="deleteProcess({{ $item->comment_id }})"><i
                                                                class="fa-solid fa-trash"></i>Delete comment</button>
                                                    @endif
                                                </div>
                    ...
                    @foreach ($productList as $item)
                        <div class="border border-primary rounded position-relative vesitable-item">
                            <div class="vesitable-img">
                                <img src="{{asset('productImage/'.$item->image)}}" style="height: 250px" class="img-fluid w-100 rounded-top"
                                    alt="">
                            </div>
