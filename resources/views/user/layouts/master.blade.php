        ...
        <div class="container px-0">
            <nav class="navbar navbar-light bg-white navbar-expand-xl">
                <a href="{{route('user#Home')}}" class="navbar-brand">
                    <h1 class="text-primary display-6">Foodie Land</h1>
                </a>
                    ...
                    <div class="d-flex m-3 me-0">
                        ...
                        <div class="nav-item dropdown">
                            <a href="#" class="nav-link dropdown-toggle my-auto mt-2" data-bs-toggle="dropdown">
                                <img src="{{ Auth::user()->profile != null ? asset('profile/' . Auth::user()->profile) : asset('default/userpp.png') }}" style="width: 50px" class="img-profile rounded-circle">
                            ...
                            <div class="dropdown-menu m-0 bg-secondary rounded-0">
                                ...
                                <a href="{{route('profile#passwordChangePage')}}" class="dropdown-item my-2">Change Password</a>
        ...
        <div class="container py-5">
            <div class="pb-4 mb-4" style="border-bottom: 1px solid rgba(226, 175, 24, 0.5) ;">
                <div class="row g-4">
                    <div class="col-lg-3">
                        <a href="#">
                            <h1 class="text-primary mb-0">Foodies Land</h1>
